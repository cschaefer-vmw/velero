...
func (*CreateVolumeRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*CreateVolumeResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*GetVolumeInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func (*GetVolumeInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{3} }
...
func (*CreateSnapshotRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{4} }
...
func (*CreateSnapshotResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{5} }
...
func (*DeleteSnapshotRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{6} }
...
func (*GetVolumeIDRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{7} }
...
func (*GetVolumeIDResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{8} }
...
func (*SetVolumeIDRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{9} }
...
func (*SetVolumeIDResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{10} }
...
func (*VolumeSnapshotterInitRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{11} }
...
func init() { proto.RegisterFile("VolumeSnapshotter.proto", fileDescriptor10) }
